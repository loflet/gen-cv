...
server_connection_string = f"Driver={{ODBC Driver 17 for SQL Server}};Server={sql_db_server};Uid={sql_db_user};Pwd={sql_db_password};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
